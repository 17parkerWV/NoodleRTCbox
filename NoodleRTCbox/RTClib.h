...
public:
  ...
  static void RTC_DS3231::adjust(uint8_t yOff, uint8_t m, uint8_t d, uint8_t hh, uint8_t mm, uint8_t ss, uint8_t dotw);
};
...
public:
  ...
  */
  ...
  static void adjust(const DateTime& dt);
void adjust(uint8_t yOff, uint8_t m, uint8_t d, uint8_t hh, uint8_t mm, uint8_t ss, uint8_t dotw);
  static DateTime now();
